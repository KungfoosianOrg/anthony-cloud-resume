# Sets up the visitor counter module for the front end webpage, along with logging, API gateways, alarms, and permissions the Lambda function needs for execution
